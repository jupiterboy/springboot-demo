...
@Getter
@Setter
public class AlarmEvent extends SpringApplicationEvent {

    private final MonitorValue monitorValue;

    public AlarmEvent(MonitorItem monitorItem, MonitorValue monitorValue) {
        super(monitorItem, MonitorEventType.ALARM_EVENT);
